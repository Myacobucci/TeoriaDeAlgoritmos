...
public class HeuristicSearchTest {
    ...
    public void bfsAlgorithmTest() {
        ...
        HeuristicSearch heuristicSearch = new HeuristicSearch(digraph,0,2);

        assertThat(heuristicSearch.getDistance(), equalTo(3));
    }
    @Test
    public void heuristicSearchTest2() {
        ...
        assertThat(heuristicSearch.getDistance(), equalTo(7));
    }
}
